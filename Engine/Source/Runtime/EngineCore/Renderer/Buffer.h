...
public:
	...
	void CreateVertexBuffer(const std::vector<Vertex>& vertices, vk::raii::Buffer& vertexBuffer, vk::raii::DeviceMemory& vertexBufferMemory, vk::raii::CommandPool& commandPool, vk::raii::Queue& graphicsQueue);
